...
class ReportController extends Controller
{
    ...
    public function sales(Request $request)
    {
        ...
        return view('admin.reports.sales', compact('summary', 'dailySales', 'customerSales', 'statusBreakdown', 'startDate', 'endDate'));
    }
    ...
    public function inventory(Request $request)
    {
        ...
        $outOfStockItems = StoreItem::where('quantity', '<=', 2)
            ->with('category')
            ->get();
    ...
    public function customers(Request $request)
    {
        ...
        return view('admin.reports.customers', compact('summary', 'topCustomers', 'creditAnalysis', 'startDate', 'endDate'));
    }
    ...
    public function processing(Request $request)
    {
        ...
        return view('admin.reports.processing', compact('summary', 'efficiency', 'statusBreakdown', 'monthlyTrend', 'startDate', 'endDate'));
    }
    ...
    public function financial(Request $request)
    {
        ...
        return view('admin.reports.financial', compact('revenue', 'inventoryValue', 'monthlyRevenue', 'paymentStatus', 'startDate', 'endDate'));
    }
    ...
    public function printSales(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.reports.pdf.sales', compact('summary', 'orders', 'startDate', 'endDate'));
    ...
    public function printFinancial(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.reports.pdf.financial', compact('revenue', 'inventoryValue', 'paymentStatus', 'startDate', 'endDate'));
