...
<div class="mb-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="{{ route('manager.orders.edit', $order) }}" class="px-6 py-2 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-lg hover:from-yellow-700 hover:to-orange-700 transition-all">
                Edit Order
            </a>
            <a href="{{ route('manager.orders.index') }}" class="px-6 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-all">
                Back to Orders
            </a>
        </div>
    </div>
