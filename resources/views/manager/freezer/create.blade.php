...
<div class="mb-6">
    <div class="flex items-center gap-4 mb-4">
        <a href="{{ route('manager.freezer.create') }}" class="text-gray-400 hover:text-white transition">
...
<div class="bg-gray-800 rounded-lg shadow-lg p-6">
    <form action="{{ route('manager.freezer.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-6 flex gap-4">
            ...
            <a href="{{ route('manager.freezer.create') }}" class="px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
                Cancel
            </a>
        </div>
    </form>
