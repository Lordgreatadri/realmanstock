...
<div class="bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
    <div class="flex gap-4 items-end">
        ...
        <a href="{{ route('manager.reports.export-customers', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition inline-flex items-center gap-2">
        ...
        <table class="min-w-full divide-y divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-700">
                @forelse($topCustomers as $index => $customer)
                    <tr>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center justify-center w-8 h-8 bg-green-600 text-white rounded-full font-bold">
                                {{ $index + 1 }}
                            </span>
                        </td>
                        <td class="px-6 py-4">
