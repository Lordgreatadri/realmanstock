...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <!-- Sales Report -->
    <a href="{{ route('manager.reports.sales') }}" class="bg-gradient-to-br from-green-600 to-emerald-600 rounded-lg p-6 text-white hover:from-green-700 hover:to-emerald-700 transition transform hover:scale-105 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h3 class="text-xl font-bold">Sales Report</h3>
                <p class="text-green-200 text-sm mt-1">Revenue and orders analysis</p>
            </div>
    ...
    <!-- Inventory Report -->
    <a href="{{ route('manager.reports.inventory') }}" class="bg-gradient-to-br from-green-600 to-teal-600 rounded-lg p-6 text-white hover:from-green-700 hover:to-teal-700 transition transform hover:scale-105 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
    ...
    <!-- Customer Report -->
    <a href="{{ route('manager.reports.customers') }}" class="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-lg p-6 text-white hover:from-blue-700 hover:to-cyan-700 transition transform hover:scale-105 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
    ...
    <!-- Processing Report -->
    <a href="{{ route('manager.reports.processing') }}" class="bg-gradient-to-br from-yellow-600 to-orange-600 rounded-lg p-6 text-white hover:from-yellow-700 hover:to-orange-700 transition transform hover:scale-105 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
    ...
    <!-- Financial Report -->
    <a href="{{ route('manager.reports.financial') }}" class="bg-gradient-to-br from-pink-600 to-rose-600 rounded-lg p-6 text-white hover:from-pink-700 hover:to-rose-700 transition transform hover:scale-105 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div>
