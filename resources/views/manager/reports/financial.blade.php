...
<div class="bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
    <div class="flex gap-4 items-end">
        ...
        <div class="flex gap-2">
            <a href="{{ route('manager.reports.export-financial', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition inline-flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                Export Excel
            </a>
            <a href="{{ route('manager.reports.print-financial', ['start_date' => $startDate, 'end_date' => $endDate]) }}" class="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition inline-flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
