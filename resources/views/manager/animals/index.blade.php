...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('manager.animals.create') }}" class="px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:shadow-lg hover:shadow-indigo-500/50 text-white rounded-lg transition">
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-xl p-4">
        <form method="GET" action="{{ route('manager.animals.index') }}" class="flex flex-wrap gap-4">
            <!-- Search -->
            ...
            <a href="{{ route('manager.animals.create') }}" class="px-6 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition">
                Reset
            </a>
        </form>
    </div>
                        ...
                        <tr class="hover:bg-gray-800 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('manager.animals.show', $animal) }}" class="px-3 py-1 bg-gray-700 hover:bg-gray-600 text-white text-sm rounded transition">
                                        View
                                    </a>
                                    <a href="{{ route('manager.animals.edit', $animal) }}" class="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white text-sm rounded transition">
                                        Edit
                                    </a>
                                    <form method="POST" action="{{ route('manager.animals.destroy', $animal) }}" onsubmit="return confirm('Are you sure you want to delete this animal?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <a href="{{ route('manager.animals.create') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:shadow-lg hover:shadow-indigo-500/50 text-white rounded-lg transition">
