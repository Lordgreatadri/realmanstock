...
<div class="mb-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="{{ route('manager.customers.show', $customer) }}" class="px-6 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-all">
                View Customer
            </a>
...
<form action="{{ route('manager.customers.update', $customer) }}" method="POST">
    @csrf
    @method('PUT')
...
<div class="mt-6">
    <form action="{{ route('manager.customers.destroy', $customer) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this customer? This action cannot be undone.');">
        @csrf
        @method('DELETE')
