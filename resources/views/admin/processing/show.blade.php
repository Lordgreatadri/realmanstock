...
<div class="mb-6 flex justify-between items-start">
    ...
    <div class="flex gap-2">
        <a href="{{ route($routePrefix . '.processing.edit', $processing) }}" 
        ...
        <a href="{{ route($routePrefix . '.processing.index') }}" 
    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <a href="{{ route($routePrefix . '.orders.show', $processing->order) }}" class="text-indigo-400 hover:text-indigo-300">
...
<div class="mt-6 bg-gray-800 rounded-lg shadow-lg p-6">
    ...
    <form action="{{ route($routePrefix . '.processing.update-status', $processing) }}" method="POST" class="flex gap-4">
        @csrf
