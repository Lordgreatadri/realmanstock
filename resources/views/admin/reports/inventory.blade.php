...
<div class="mb-6 flex justify-between items-start">
    ...
    <form action="{{ route('admin.reports.export-inventory') }}" method="GET" class="inline">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        @foreach($freezerInventory as $item)
            <div class="bg-gray-700 rounded-lg p-4">
                ...
                <p class="text-sm text-indigo-400 font-semibold">GH₵{{ number_format($item->total_value, 2) }}</p>
            </div>
        @endforeach
    </div>
</div>
