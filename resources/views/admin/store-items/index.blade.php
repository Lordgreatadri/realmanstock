...
<div class="mb-6 flex justify-between items-start">
    ...
    <a href="{{ route($routePrefix . '.store-items.create') }}" 
...
<div class="bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
    <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route($routePrefix . '.store-items.index') }}" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
                Clear
            </a>
        </div>
    </form>
                ...
                @forelse($items as $item)
                    <tr class="hover:bg-gray-750">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex gap-2">
                                <a href="{{ route($routePrefix . '.store-items.show', $item) }}" 
