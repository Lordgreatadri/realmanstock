...
<div class="mb-6">
    <div class="flex items-center gap-4 mb-4">
        <a href="{{ route($routePrefix . '.store-items.show', $item) }}" class="text-gray-400 hover:text-white transition">
...
<div class="bg-gray-800 rounded-lg shadow-lg p-6">
    <form action="{{ route($routePrefix . '.store-items.update', $item) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mt-6 flex gap-4">
            ...
            <a href="{{ route($routePrefix . '.store-items.show', $item) }}" class="px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
                Cancel
            </a>
        </div>
    </form>

    <form action="{{ route($routePrefix . '.store-items.destroy', $item) }}" method="POST" 
