...
<div class="mb-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="{{ route($routePrefix . '.customers.edit', $customer) }}" class="px-6 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all">
                Edit Customer
            </a>
