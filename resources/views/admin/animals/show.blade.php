...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route($routePrefix . '.animals.edit', $animal) }}" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
                ...
                <div class="space-y-2">
                    <a href="{{ route($routePrefix . '.animals.edit', $animal) }}" class="block w-full px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-center rounded-lg transition">
                        Edit Animal
                    </a>
                    <form method="POST" action="{{ route($routePrefix . '.animals.destroy', $animal) }}" onsubmit="return confirm('Are you sure you want to delete this animal? This action cannot be undone.');">
                        @csrf
                        @method('DELETE')
